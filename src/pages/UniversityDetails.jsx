...
const UniversityDetails = () => {
   ...
   if (!uni) {
     return (
       <div className="pt-24 min-h-screen text-center flex flex-col items-center justify-center p-6 bg-slate-50">
          ...
          <p className="text-slate-500 font-medium mb-8 max-w-md">The specific program or university record you're looking for does not exist in the training database.</p>
          <button onClick={() => navigate(-1)} className="px-6 py-3 bg-[#0047ad] text-white font-bold rounded-xl shadow-[0_4px_12px_rgba(0,71,173,0.3)] hover:scale-105 transition-all">
             Go Back to Console
          </button>
       </div>
     );
   ...
   return (
       <div className="min-h-screen bg-slate-50 pb-24 font-inter text-slate-800">
           ...
           <div className="h-[60px] bg-white border-b border-slate-200 sticky top-0 z-50 flex items-center px-6 lg:px-12 shadow-sm">
           ...
           <div className="bg-[#0b132b] text-white overflow-hidden relative">
               ...
               <div className="max-w-[1400px] mx-auto px-6 lg:px-12 pt-16 pb-20 flex flex-col xl:flex-row gap-10 justify-between xl:items-end relative z-10 border-b-4 border-[#ff6b00]">
                  ...
                  <div className="flex-1">
                      ...
                      <h1 className="text-4xl md:text-5xl lg:text-6xl font-black text-white leading-tight tracking-tight mb-5">{uni.name}</h1>
               ...
               <div className="grid grid-cols-1 xl:grid-cols-[1fr_380px] gap-10 items-start">
                  ...
                  <div className="space-y-10">
                      ...
                      <div className="bg-white rounded-2xl shadow-[0_2px_10px_rgba(0,0,0,0.03)] p-8">
                          <h3 className="text-[13px] font-black text-slate-400 uppercase tracking-[0.2em] flex items-center gap-2 mb-8 pb-4 border-b border-slate-100">
                          ...
                          <div>
                              {uni.extendedDetails?.programs ? (
                                 <div className="flex flex-col gap-6">
                                    ...
                                    <div className="flex flex-wrap border-b border-slate-200 gap-4 sm:gap-8">
                                       <button 
                                    ...
                                    <div className="flex lg:flex-row flex-col gap-8 mt-2">
                                             ...
                                             return (
                                                <div key={i} className={`border rounded-xl transition-all overflow-hidden ${isProgSelected ? 'border-[#ff6b00] ring-1 ring-[#ff6b00]/20' : 'border-slate-200'}`}>
                                                   ...
                                                   <button 
                                                      ...
                                                      className={`w-full text-left p-5 flex justify-between items-center transition-colors ${isProgSelected ? 'bg-[#fff7ed]' : 'bg-white hover:bg-slate-50'}`}
                                                   >
                                                      <div>
                                                   ...
                                                   {isProgSelected && prog.specializations && (
                                                      <div className="p-5 bg-slate-50 border-t border-slate-100 grid grid-cols-1 sm:grid-cols-2 gap-3">
                                       ...
                                       <div className="w-full lg:w-[350px] shrink-0">
                                          {selectedSpec ? (
                                             <div className="bg-slate-900 text-white rounded-2xl p-8 shadow-xl sticky top-28 transform animate-in fade-in zoom-in-95 duration-200">
                                             ...
                                             <div className="h-full min-h-[300px] border-2 border-dashed border-slate-300 rounded-2xl bg-slate-50 p-8 flex flex-col items-center justify-center text-center">
                                             ...
                                             <div className="h-full min-h-[300px] border border-slate-200 rounded-2xl bg-white p-8 flex flex-col items-center justify-center text-center">
                      ...
                      {uni.extendedDetails && (
                         <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                            ...
                            <div className="bg-white rounded-2xl shadow-[0_2px_10px_rgba(0,0,0,0.03)] p-8 lg:col-span-2">
                                <h3 className="text-[13px] font-black text-slate-400 uppercase tracking-[0.2em] flex items-center gap-2 mb-8 pb-4 border-b border-slate-100">
                            ...
                            <div className="bg-white rounded-2xl shadow-[0_2px_10px_rgba(0,0,0,0.04)] p-8 border-t-[4px] border-t-[#ff6b00]">
                            ...
                            {/* Exam Protocols Box */}
                            <div className="bg-white rounded-2xl shadow-[0_2px_10px_rgba(0,0,0,0.04)] p-8 border-t-[4px] border-t-purple-500 flex flex-col">
                                <h3 className="text-[12px] font-black text-slate-400 uppercase tracking-[0.2em] flex items-center gap-2 mb-6">
                  ...
                  <div className="w-full">
                      <div className="bg-white rounded-2xl shadow-[0_8px_30px_rgba(0,0,0,0.04)] p-8 sticky top-[100px]">
                          <h3 className="text-xl font-black text-slate-900 mb-4">Executive Terminal</h3>
                          
                          <p className="text-slate-500 text-[14px] font-medium leading-relaxed mb-8">Pipeline ready for {uni.name}. Verify student credentials before dispatching the standard pitch sequence.</p>
                          ...
                          {uni.extendedDetails?.leadLocking && (
                             <div className="mt-10 bg-[#fff5f5] border border-red-100 p-5 rounded-2xl relative">
